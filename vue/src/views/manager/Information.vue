<template>
  <div class="manager-page-container">
    ...
    <el-dialog title="资讯信息" :visible.sync="fromVisible" width="600px" :close-on-click-modal="false" destroy-on-close @close="cancel" custom-class="apple-dialog">
      <el-form label-width="100px" style="padding-right: 40px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="name" label="资讯名称">
          <el-input v-model="form.name" autocomplete="off" class="apple-input" placeholder="请输入资讯名称"></el-input>
        </el-form-item>
        <el-form-item prop="description" label="资讯介绍">
    ...
    <el-dialog title="资讯介绍" :visible.sync="editorVisible" width="60%" custom-class="apple-dialog">
